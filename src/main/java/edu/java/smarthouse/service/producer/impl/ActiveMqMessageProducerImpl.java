package edu.java.smarthouse.service.producer.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import edu.java.smarthouse.common.dto.EventNotification;
import edu.java.smarthouse.service.producer.ActiveMqMessageProducer;
...
public class ActiveMqMessageProducerImpl implements ActiveMqMessageProducer {
    ...
    private static final String SMARTHOUSE_QUEUE = "smarthouse";
    ...
    public void sendNotification(EventNotification eventNotification) throws JMSException, JsonProcessingException {
        ...
        Destination producerDestination = producerSession.createQueue(SMARTHOUSE_QUEUE);
